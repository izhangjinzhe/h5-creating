 ...
 * @LastEditors: jinzhe
 * @LastEditTime: 2021-03-25 14:38:09
-->
<template>
      ...
      <div class="edit">
        <div class="box">
          <div class="fixed-item">
            <el-input size="medium" prefix-icon="el-icon-search" readonly=""></el-input>
          </div>
          <div class="fixed-item">
            <el-tabs >
              <el-tab-pane label="全部" name="1"></el-tab-pane>
              <el-tab-pane label="店铺" name="2"></el-tab-pane>
              <el-tab-pane label="发现" name="3"></el-tab-pane>
              <el-tab-pane label="上新" name="4"></el-tab-pane>
              <el-tab-pane label="销量" name="5"></el-tab-pane>
              <el-tab-pane label="特卖" name="6"></el-tab-pane>
            </el-tabs>
          </div>
          <draggable
